...
function BusItem({item: bus}: { item: IBus }) {
	return (
		<View style={{shadowOffset: {width: 0, height: 3}, shadowOpacity: 0.2, shadowRadius: 5, elevation: 6, borderRadius: 12, backgroundColor: 'white'}}>
			<LinearGradient colors={['#CF3239', '#FDBB8A']} start={{x: 0.0, y: 0.0}} end={{x: 1.0, y: 1.0}} style={{borderRadius: 12, padding: 2}}>
						...
						<View className={'flex-row justify-between'}>
							<View className={'flex-row gap-2 items-center mb-2'}>
								<View className={'flex-row items-center'}>
									<LinearGradient colors={['#CF3239', '#FC5431']} start={{x: 0, y: 0}} end={{x: 1, y: 1}}
									                style={{width: 36, height: 36, borderRadius: 8, justifyContent: 'center', alignItems: 'center'}}>
