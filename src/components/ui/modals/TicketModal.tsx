            ...
            <View className={'flex-1 justify-center items-center'} style={{backgroundColor: 'rgba(42, 37, 38, 0.9)'}}>
                ...
                {bookingInfo && bookingInfo.bus ? (
                    <View className={'bg-white overflow-hidden rounded-xl w-[90%] p-4 shadow-lg relative'}>
                        <Text className={'mb-2 text-center text-xl font-okra font-semibold'}>Your Ticket</Text>
                        ...
                        <View className={'mt-3'}>
                            <Text className={'text-gray-700 font-okra font-semibold'}>{bookingInfo.bus.company}</Text>
                            <Text className={'text-gray-500 text-sm font-okra'}>{bookingInfo.bus.busType}</Text>
                        </View>

                        <View className={'mt-3'}>
                            <Text className={'text-gray-700 font-okra font-semibold'}>Seat(s)</Text>
                        ...
                        <View>
                            <Text className={'text-gray-700 font-okra font-semibold'}>Ticket #: {bookingInfo.ticketExternalId}</Text>
                            <Text className={'text-gray-700 font-okra font-semibold'}>PNR: {bookingInfo.pnr}</Text>
